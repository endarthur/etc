// ═══════════════════════════════════════════
// WINDOW MANAGER (ported from Patchbay 401)
// ═══════════════════════════════════════════
...
function saveLayout() {
  ...
  localStorage.setItem('pb501-layout', JSON.stringify(layout));
}

function restoreLayout() {
  let layout;
  try { layout = JSON.parse(localStorage.getItem('pb501-layout')); } catch(e) {}
